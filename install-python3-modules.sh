...
pip3 install RPi.GPIO httplib2 google-api-python-client oauth2client requests Pillow speedtest yeelight flake8 pep8-naming flake8-bugbear
...
# smbus
pip install -e git+https://github.com/pimoroni/py-smbus.git#egg=smbus\&subdirectory=library
