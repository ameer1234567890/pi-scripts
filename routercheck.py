...
# *-* coding: utf-8 -*-
"""Periodically check if the router is up and reboot if necessary"""
...
while True:
    ...
    while i in range(1, 3):
        ...
        print('{} Either router is not working or Wifi interface is down. '
              'Restarting Wifi interface...'.format(datetime.datetime.now()))
        restart_wlan_if()
        time.sleep(5)
        response = ping_test()
        if response == 0:
            print('{} Router was OK! Wifi interface was down! Now OK!'
